...
import com.atilika.kuromoji.xz.XZIOException;
import com.atilika.kuromoji.xz.common.DecoderUtil;

public class IndexHash extends IndexBase {
    private com.atilika.kuromoji.xz.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new com.atilika.kuromoji.xz.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new com.atilika.kuromoji.xz.check.CRC32();
        }
    }
